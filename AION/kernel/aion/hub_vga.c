...
#define MANUAL_CELL_WIDTH  30
#define MANUAL_CELL_HEIGHT 12

static int g_module_count = 5; // Default to 5
static int g_cols = 3;
static int g_rows = 2;
...
void hub_vga_init(int module_count) {
    ...
    // Determine optimal grid layout based on module count
    if (module_count <= 4) {
        g_cols = 2;
        g_rows = 2;
